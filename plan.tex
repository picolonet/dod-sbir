...
\noindent{\bf 1. Medium latency Wide-area networks :} We shall utilize existing research \cite{gustaf2013, haq2017}
...
\noindent{\bf 2. High latency WANs:}  We shall programmatically emulate networks with high-latency and low-bandwidth
...
\noindent{\bf3. Other failure modes:} Apart from network failures, we shall also study the performance of the blockchain
